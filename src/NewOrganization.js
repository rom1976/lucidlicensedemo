...
const NewOrganization = (props) =>{
              ...
              const [saveToogle, setSaveToggle] = useState(false);
              ...
              const formHandler = () =>{   
                      if (!organizationName  && !orgDetails){
                ...
                const OrganizationDetails ={OrganizationDetails:{ 
                    ...
                    ImageUrl:imageURLServer && imageURLServer.response.imageUrl || orgDetails && orgDetails.OrganizationDetails.ImageUrl || '', 
  ...
                     <Grid.Column width={6}>  
       ...
                   
               ...
               <Grid.Row >
                   ...
                   { saveToogle ? <Link to='/NewProperty' style={{color:'white'}}><Button color='blue'> Next </Button></Link> : 
                     <Button color='blue'  onClick={formHandler}>  Save </Button>
                   } 
                   </Grid.Column>
